...
func (m *GroupMutation) AppendPermissions(s []string) {
...
func (m *GroupMutation) AppendedPermissions() ([]string, bool) {
...
// SetValidUntil sets the "validUntil" field.
func (m *TokenMutation) SetValidUntil(t time.Time) {
	m.validUntil = &t
}

// ValidUntil returns the value of the "validUntil" field in the mutation.
func (m *TokenMutation) ValidUntil() (r time.Time, exists bool) {
	v := m.validUntil
	if v == nil {
		return
	}
...
// OldValidUntil returns the old "validUntil" field's value of the Token entity.
// If the Token object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TokenMutation) OldValidUntil(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldValidUntil is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetValidUntil resets all changes to the "validUntil" field.
func (m *TokenMutation) ResetValidUntil() {
	m.validUntil = nil
}

// SetSend sets the "send" field.
func (m *TokenMutation) SetSend(b bool) {
	m.send = &b
}

// Send returns the value of the "send" field in the mutation.
func (m *TokenMutation) Send() (r bool, exists bool) {
	v := m.send
	if v == nil {
		return
	}
...
// OldSend returns the old "send" field's value of the Token entity.
// If the Token object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TokenMutation) OldSend(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSend is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSend requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSend: %w", err)
	}
	return oldValue.Send, nil
}

// ResetSend resets all changes to the "send" field.
func (m *TokenMutation) ResetSend() {
	m.send = nil
}
...
func (m *TokenMutation) Fields() []string {
	...
	if m.validUntil != nil {
		fields = append(fields, token.FieldValidUntil)
	}
	if m.send != nil {
		fields = append(fields, token.FieldSend)
	}
	if m.createdAt != nil {
...
// EmailConfirmed returns the value of the "emailConfirmed" field in the mutation.
...
// OldEmailConfirmed returns the old "emailConfirmed" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
// ResetEmailConfirmed resets all changes to the "emailConfirmed" field.
func (m *UserMutation) ResetEmailConfirmed() {
	m.emailConfirmed = nil
}
