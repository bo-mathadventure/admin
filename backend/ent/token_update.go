...
func (tu *TokenUpdate) SetValidUntil(t time.Time) *TokenUpdate {
	tu.mutation.SetValidUntil(t)
	return tu
}

// SetNillableValidUntil sets the "validUntil" field if the given value is not nil.
func (tu *TokenUpdate) SetNillableValidUntil(t *time.Time) *TokenUpdate {
	if t != nil {
		tu.SetValidUntil(*t)
	}
	return tu
...
func (tu *TokenUpdate) SetSend(b bool) *TokenUpdate {
	tu.mutation.SetSend(b)
	return tu
}

// SetNillableSend sets the "send" field if the given value is not nil.
func (tu *TokenUpdate) SetNillableSend(b *bool) *TokenUpdate {
	if b != nil {
		tu.SetSend(*b)
	}
	return tu
...
func (tu *TokenUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.ValidUntil(); ok {
		_spec.SetField(token.FieldValidUntil, field.TypeTime, value)
	}
	if value, ok := tu.mutation.Send(); ok {
...
// SetValidUntil sets the "validUntil" field.
func (tuo *TokenUpdateOne) SetValidUntil(t time.Time) *TokenUpdateOne {
	tuo.mutation.SetValidUntil(t)
	return tuo
}

// SetNillableValidUntil sets the "validUntil" field if the given value is not nil.
func (tuo *TokenUpdateOne) SetNillableValidUntil(t *time.Time) *TokenUpdateOne {
	if t != nil {
		tuo.SetValidUntil(*t)
	}
	return tuo
...
// SetSend sets the "send" field.
func (tuo *TokenUpdateOne) SetSend(b bool) *TokenUpdateOne {
	tuo.mutation.SetSend(b)
	return tuo
}

// SetNillableSend sets the "send" field if the given value is not nil.
func (tuo *TokenUpdateOne) SetNillableSend(b *bool) *TokenUpdateOne {
	if b != nil {
		tuo.SetSend(*b)
	}
	return tuo
...
func (tuo *TokenUpdateOne) sqlSave(ctx context.Context) (_node *Token, err error) {
	...
	if value, ok := tuo.mutation.ValidUntil(); ok {
		_spec.SetField(token.FieldValidUntil, field.TypeTime, value)
	}
	if value, ok := tuo.mutation.Send(); ok {
		_spec.SetField(token.FieldSend, field.TypeBool, value)
	}
