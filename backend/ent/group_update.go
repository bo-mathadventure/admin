...
func (gu *GroupUpdate) AppendPermissions(s []string) *GroupUpdate {
	gu.mutation.AppendPermissions(s)
	return gu
}
...
func (gu *GroupUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := gu.mutation.AppendedPermissions(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, group.FieldPermissions, value)
		})
	}
...
// AppendPermissions appends s to the "permissions" field.
func (guo *GroupUpdateOne) AppendPermissions(s []string) *GroupUpdateOne {
	guo.mutation.AppendPermissions(s)
	return guo
}
...
func (guo *GroupUpdateOne) sqlSave(ctx context.Context) (_node *Group, err error) {
	...
	if value, ok := guo.mutation.AppendedPermissions(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, group.FieldPermissions, value)
		})
	}
